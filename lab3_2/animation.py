...
def velocity_changing(velocity, x, y):
    vel_normal_0 = gr.Point(r(x,y).x*scalar_multiplication(r(x,y), velocity), r(x,y).y*scalar_multiplication(r(x,y), velocity))
    vel_tau = gr.Point(n(x,y).x*scalar_multiplication(n(x,y), velocity), n(x,y).y*scalar_multiplication(n(x,y), velocity))
